...
const babelParser = __webpack_require__(/*! @babel/parser */ "./node_modules/@babel/parser/lib/index.js");
...
const panel_1 = __webpack_require__(/*! ./panel */ "./src/panel.ts");
...
const vscode = __webpack_require__(/*! vscode */ "vscode");
const getNonce_1 = __webpack_require__(/*! ./getNonce */ "./src/getNonce.ts");
const TestParser_1 = __webpack_require__(/*! ./TestParser */ "./src/TestParser.ts");
class ReacTreePanel {
    constructor(extContext, extensionPath, column) {
        this._disposables = [];
        console.log('SECOND');
        this._extensionPath = extensionPath;
        this._extContext = extContext;
        const state = extContext.workspaceState.get('reactree');
        if (state) {
            this.parser = new TestParser_1.TestParser(state.filePath);
        ...
        this._panel.webview.onDidReceiveMessage((msg) => __awaiter(this, void 0, void 0, function* () {
            switch (msg.type) {
                ...
                case "onFile": {
                    ...
                    this.parser = new TestParser_1.TestParser(msg.value);
                    this.parser.parse();
                    this.updateView();
                    break;
                }
                ...
                case "onViewFile": {
                    ...
                    const editor = yield vscode.window.showTextDocument(doc, { preserveFocus: false, preview: false });
                    break;
                }
                ...
                case "onSettingsAcquire": {
                    ...
                    const settings = yield vscode.workspace.getConfiguration('reactree');
                ...
                case "onNodeToggle": {
                    ...
                    this._extContext.workspaceState.update('reactree', this.parser.toggleNode(msg.value.id, msg.value.expanded));
                    break;
                }
