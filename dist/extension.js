...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider("sapling-sidebar", sidebarProvider));
    // Register command to generate tree from current file on status button click or from explorer context
    context.subscriptions.push(vscode.commands.registerCommand("sapling.generateTree", (uri) => __awaiter(this, void 0, void 0, function* () {
        yield vscode.commands.executeCommand('workbench.view.extension.sapling-sidebar-view');
...
const SaplingParser_1 = __webpack_require__(4);
...
class SidebarProvider {
    constructor(context) {
        ...
        this.statusButtonClicked = (uri) => {
            ...
            if (fileName) {
                this.parser = new SaplingParser_1.SaplingParser(fileName);
                this.parser.parse();
                this.updateView();
            }
        };
        ...
        if (state) {
            this.parser = new SaplingParser_1.SaplingParser(state.filePath);
        ...
        webviewView.webview.onDidReceiveMessage((data) => __awaiter(this, void 0, void 0, function* () {
            ...
            switch (data.type) {
                ...
                case 'onFile': {
                    ...
                    this.parser = new SaplingParser_1.SaplingParser(data.value);
                    this.parser.parse();
                    this.updateView();
                    break;
                }
                ...
                case 'onViewFile': {
                    ...
                    const doc = yield vscode.workspace.openTextDocument(data.value);
                ...
                case 'onSettingsAcquire': {
                    ...
                    const settings = yield vscode.workspace.getConfiguration('sapling');
                    // send a message back to the webview with the data on settings
                    webviewView.webview.postMessage({
                        type: 'settings-data',
                        value: settings.view,
                ...
                case 'onNodeToggle': {
                    ...
                    this.context.workspaceState.update('sapling', this.parser.toggleNode(data.value.id, data.value.expanded));
                    break;
                }
...
var _SaplingParser_instances, _SaplingParser_traverseTree;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SaplingParser = void 0;
const babelParser = __webpack_require__(5);
const path = __webpack_require__(6);
const fs = __webpack_require__(7);
const getNonce_1 = __webpack_require__(3);
class SaplingParser {
    constructor(filePath) {
        _SaplingParser_instances.add(this);
        ...
        const callback = (node) => {
            if (node.filePath === filePath) {
                node.children.forEach(child => {
                    __classPrivateFieldGet(this, _SaplingParser_instances, "m", _SaplingParser_traverseTree).call(this, getChildNodes, child);
                });
                const newNode = this.parser(node);
                __classPrivateFieldGet(this, _SaplingParser_instances, "m", _SaplingParser_traverseTree).call(this, matchExpand, newNode);
                children = [];
            }
        };
        __classPrivateFieldGet(this, _SaplingParser_instances, "m", _SaplingParser_traverseTree).call(this, callback, this.tree);
        return this.tree;
    }
...
exports.SaplingParser = SaplingParser;
_SaplingParser_instances = new WeakSet(), _SaplingParser_traverseTree = function _SaplingParser_traverseTree(callback, node = this.tree) {
    if (!node) {
        return;
    }
    callback(node);
    node.children.forEach((childNode) => {
        __classPrivateFieldGet(this, _SaplingParser_instances, "m", _SaplingParser_traverseTree).call(this, callback, childNode);
    });
};
