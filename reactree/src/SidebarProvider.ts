...
export class SidebarProvider implements vscode.WebviewViewProvider {
  ...
  constructor(context: vscode.ExtensionContext) {
    ...
    const state: Tree | undefined = context.workspaceState.get('reactree');
    if (state) {
  ...
  public resolveWebviewView(webviewView: vscode.WebviewView) {
    ...
    vscode.workspace.onDidChangeConfiguration((e) => {
      ...
      const settings = vscode.workspace.getConfiguration('reactree');
    ...
    webviewView.webview.onDidReceiveMessage(async (data) => {
      ...
      switch (data.type) {
        ...
        case "onFile": {
          ...
          this.parser = new TestParser(data.value);
          this.parser.parse();
          this.updateView();
          break;
        }
  ...
  public statusButtonClicked = (uri: vscode.Uri | undefined) => {
    ...
    if (fileName) {
      this.parser = new TestParser(fileName);
      this.parser.parse();
      this.updateView();
    }
  };
